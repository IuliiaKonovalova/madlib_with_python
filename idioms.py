...
idioms_dictionary = {
    ...
    'Get something out of your system': 'Do the thing you\'ve been wanting so you can move on',
    ...
    'He has bigger fish to fry':	'He has bigger things to deal with than what we are talking about now',
    ...
    'The devil is in the details':	'It looks good from a distance, but if you look closer, there are problems',
